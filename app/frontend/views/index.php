...
(!isset($_SESSION['erros'])) ? $erros = NULL : $erros = $_SESSION['erros'];

(!isset($_SESSION['success'])) ? $success = false : $success = $_SESSION['success'];
...
?>
    ...
    <head>
        ...
        <style><?php include __DIR__ . "/../web/css/style.css"; ?></style>
        <?php if ($success) : ?>
            <style><?php include __DIR__ . "/../web/css/components/successMsg.css"; ?></style>
        <?php endif ?>
    </head>
            ...
            <div class="wrap-left">
                <div class="navbar">
                    ...
                    <div class="navlinks">
                        ...
                        <a class="middle" href="#how">How It works</a>
                        <a href="#contact">Contact</a>
                    </div>
                </div>
                <div class="subscription">
                    <div class="sub-wrap">
                        <div class="inner-warap">

                            <?php ($success) ? include __DIR__ . '/components/successMsg.php' : include __DIR__ . '/components/submitForm.php'; ?>
